                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                            <div class="text-center text-md-center mb-4 mt-md-0">
                                <h1 class="mb-0 h3">🌾 Sistema Agrícola</h1>
                                <p class="text-gray">Inicia sesión en tu cuenta</p>
                            </div>
                            <form method="POST" action="{{ route('login') }}" class="mt-4">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" class="form-control @error('email') is-invalid @enderror" placeholder="ejemplo@empresa.com" id="email" name="email" value="{{ old('email') }}" required autofocus>
                                    </div>
                                    @error('email')
